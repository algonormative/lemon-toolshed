...
describe('a settled payment pings the owner', () => {
  test('a third party paying gets the loud message, once', async () => {
    ...
    assert.match(hit.text, /\$0\.004/, 'the alert does not carry the amount in dollars');
